...
//				<div style="font-size:52px;position: absolute;top: 35%;left: 50%;" class="fa fa-spinner fa-spin"></div>\
//			</div>\
//	');
  
  $templateCache.put('angular-busy.html','<div class="cg-busy-materialize-wrapper"><div class="cg-busy-materialize-loader"></div></div>');
